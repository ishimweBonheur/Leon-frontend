...
export default function UsersPage() {
  ...
  return (
    <div className="p-8">
      ...
      <h2 className="text-2xl font-bold mb-6 dark:text-white ">All Registered Users</h2>
      </div>
      <div className="overflow-x-auto rounded-lg shadow">
      <table className="w-full min-w-[700px] border-collapse bg-white dark:bg-gray-900 text-sm text-left text-gray-500 dark:text-gray-400">
  <thead>

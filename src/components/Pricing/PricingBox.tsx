...
const PricingBox = (props: {
  ...
  return (
    ...
    >
      <div className="relative z-10 rounded-sm bg-white px-8 py-10 shadow-three 
        hover:shadow-one dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark transition-all duration-300">
        ...
        <div className="mb-8 border-b border-body-color border-opacity-10 pb-8 
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex w-full items-center justify-center rounded-sm bg-primary p-3 
            text-base font-semibold text-white transition duration-300 ease-in-out hover:bg-opacity-80 
            hover:shadow-signUp"
          >
            Start Free Trial
          </motion.button>
